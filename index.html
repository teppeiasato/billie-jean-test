...
// 🎯 各音源（1.mp3〜13.mp3）の歌詞に完全対応させた30問のクイズデータ
const quizData = [
    // === STAGE 1: 単語・熟語部門 (10問) ===
    { id: 1,  stage: 1, type: 'choice', audioKey: 'music1',  instruction: '【単語・熟語】スライドの中で、彼女の美しさを例えた "beauty queen from a movie scene" の意図として書かれているものはどれ？', choices: ['実際に映画の主役だった', '非現実的な美しさで、虚飾に満ちた存在であること', 'マイケルの本当の恋人だった', '母親が推薦した女性だった'], answer: '非現実的な美しさで、虚飾に満ちた存在であること', explanation: 'スライド4の「比喩の意図」に「非現実的な美しさ＝正体がわからない、虚飾に満ちた存在であることを示唆している」と明記されています。' },
    { id: 2,  stage: 1, type: 'choice', audioKey: 'music9',  instruction: '【単語・熟語】スライド2に書かれている、マイケルがこの曲に込めた「メディア社会への警告」とは何のこと？', choices: ['音楽の著作権の侵害', '嘘がいつの間にか真実として扱われること', 'テレビの画質が悪すぎること', 'SNSの誹謗中傷'], answer: '嘘がいつの間にか真実として扱われること', explanation: 'スライド2の「嘘が真実になる恐怖」の項目に「嘘がいつの間にか真実として扱われるメディア社会への警告」と書かれています。' },
    { id: 3,  stage: 1, type: 'choice', audioKey: 'music2',  instruction: '【単語・熟語】スライド5に書かれている “Don\'t mind” の正しいニュアンス（役割）はどれ？', choices: ['相手を励ます「ドンマイ」', '失礼な質問をする前の「クッション言葉」', '「私は何も気にしない」という拒絶', '忘れてほしいときの言葉'], answer: '失礼な質問をする前の「クッション言葉」', explanation: 'スライド5の「Don\'t mind」の解説に「失礼な質問をする前のクッション言葉です」と書かれています。' },
    { id: 4,  stage: 1, type: 'choice', audioKey: 'music7',  instruction: '【単語・熟語】スライド10に書かれている "go around ~ing" が持つ、特有の響き（ニュアンス）はどれ？', choices: ['楽しく歩き回る', '不誠実なことをして回る', '計画的に進める', '友達をたくさん作る'], answer: '不誠実なことをして回る', explanation: 'スライド10に「特に『不誠実なことをして回る』という否定的な響きがあります」と書かれています。' },
    { id: 5,  stage: 1, type: 'choice', audioKey: 'music1',  instruction: '【単語・熟語】スライド4の語彙タグに書かれている "more like" の日本語訳はどれ？', choices: ['もっと好き', '似ている', 'むしろ〜に近い', '以前のように'], answer: 'むしろ〜に近い', explanation: 'スライド4の語彙タグに「more like：むしろ〜に近い」と記載されています。' },
    { id: 6,  stage: 1, type: 'choice', audioKey: 'music4',  instruction: '【単語・熟語】スライド7の熟語解説に書かれている "cause a scene" の意味はどれ？', choices: ['注目を浴びようとして騒動を起こす', '映画のワンシーンを撮影する', '静かに立ち去る', '理由を説明する'], answer: '注目を浴びようとして騒動を起こす', explanation: 'スライド7に「注目を浴びようとして騒動を起こすこと」と書かれています。' },
    { id: 7,  stage: 1, type: 'choice', audioKey: 'music3',  instruction: '【単語・熟語】スライド6に書かれている、円形ステージの比喩表現 "in the round" が表す意味はどれ？', choices: ['楽しくみんなで踊ること', '世間の好奇の目に晒され、逃げ場のない疑惑の中心に立たされること', 'マイケルのステージの端で踊ること', '彼女が主役の映画の舞台'], answer: '世間の好奇の目に晒され、逃げ場のない疑惑の中心に立たされること', explanation: 'スライド6に「世間の好奇の目に晒され、逃げ場のない疑惑の中心に立たされることの比喩的な表現」と書かれています。' },
    { id: 8,  stage: 1, type: 'choice', audioKey: 'music12', instruction: '【単語・熟語】スライド15に書かれている、"kid" と "son" の言葉のニュアンスの違いとして正しいものはどれ？', choices: ['kidは男の子で、sonは女の子', 'kidは客観的な「子供」、sonは血縁を表す「自分の息子」', 'kidのほうが年齢が高い子供を指す', 'スライドに違いは書かれていない'], answer: 'kidは客観的な「子供」、sonは血縁を表す「自分の息子」', explanation: 'スライド15に「Kidは一般的な『子供』という客観的な言葉、Sonは『自分の息子』という血縁を表す強い言葉」と書かれています。' },
    { id: 9,  stage: 1, type: 'choice', audioKey: 'music9',  instruction: '【単語・熟語】スライド2に書かれている「ムーンウォーク禁止令」が出た本当の理由はどれ？', choices: ['ダンスの難易度が高すぎたから', '廊下や階段で後ろ向きに歩いて衝突する生徒が続出したから', 'マイケルの禁止を求めたから', '学校の床が傷つくから'], answer: '廊下や階段で後ろ向きに歩いて衝突する生徒が続出したから', explanation: 'スライド2に「廊下や階段で後ろ向きに歩いて衝突する生徒が続出したため『ムーンウォーク禁止令』が出るほどの社会現象となった」とあります。' },
    { id: 10, stage: 1, type: 'choice', audioKey: 'music4',  instruction: '【単語・熟語】スライド7に書かれている、マイケルが「Billie Jean」という架空の名前を選んだ配慮（理由）はどれ？', choices: ['実在のテニス選手の名前だったから', '個人の特定を避けるため', '母親の本名だったから', '映画のタイトルだったから'], answer: '個人の特定を避けるため', explanation: 'スライド7の「名前の由来」に「個人の特定を避けるマイケルの配慮でもあります」と明記されています。' },

    // === STAGE 2: 文法部門 (10問) ===
    { id: 11, stage: 2, type: 'choice', audioKey: 'music3',  instruction: '【文法】スライド6に書かれている関係代名詞 [ who ] は、直前のどの言葉を説明していますか？', choices: ['floor', 'the one', 'dance', 'round'], answer: 'the one', explanation: 'スライド6の文法解説に「直前の the one を後ろから説明しています」と書かれています。' },
    { id: 12, stage: 2, type: 'choice', audioKey: 'music11', instruction: '【文法】スライド14に書かれている “She’s just a girl [ who ] claims that...” の [ who ] の文法的役割（格）は何ですか？', choices: ['主格の関係代名詞', '目的格の関係代名詞', '所有格の関係代名詞', '疑問代名詞'], answer: '主格の関係代名詞', explanation: 'スライド14の最重要ポイントに「関係代名詞 who」「主格」と記載されています。' },
    { id: 13, stage: 2, type: 'choice', audioKey: 'music11', instruction: '【文法】スライド14に書かれている “claims that I am the one” の [ that ] の文法的役割は何ですか？', choices: ['関係代名詞', '接続詞', '指示代名詞', '疑問詞'], answer: '接続詞', explanation: 'スライド14の文法解説に「接続詞 that は『〜ということ』という内容の塊を作ります」と書かれています。' },
    { id: 14, stage: 2, type: 'choice', audioKey: 'music6',  instruction: '【文法】スライド9に書かれている “Be careful of what you do” の [ what ] の文法的な説明として正しいものはどれ？', choices: ['「何？」という疑問を表す', '「こと・もの」という名詞の塊を作る関係代名詞', '理由を表す接続詞', '動詞の過去形'], answer: '「こと・もの」という名詞の塊を作る関係代名詞', explanation: 'スライド9に「whatは『何？』という疑問ではなく、名詞の塊を作る関係代名詞です」と書かれています。' },
    { id: 15, stage: 2, type: 'choice', audioKey: 'music8',  instruction: '【文法】スライド11に書かれている “Be careful of who you love” の [ who you love ] は何という文法構造ですか？', choices: ['間接疑問文（疑問詞+S+V）', '分詞構文', '不定詞の形容詞用法', '関係副詞'], answer: '間接疑問文（疑問詞+S+V）', explanation: 'スライド11に「前置詞 of の後ろに間接疑問の塊がきています」「疑問詞+S+V」と書かれています。' },
    { id: 16, stage: 2, type: 'choice', audioKey: 'music5',  instruction: '【文法】スライド8に書かれている “dreamed of bein\' the one” で、なぜ be が bein\' (being) の形になっているのですか？', choices: ['過去形にするため', '進行形にするため', '前置詞 of の後ろなので動名詞にする必要があるから', '受動態にするため'], answer: '前置詞 of の後ろなので動名詞にする必要があるから', explanation: 'スライド8に「of (前置詞) の後ろなので、beが being (動名詞) になっています」と書かれています。' },
    { id: 17, stage: 2, type: 'choice', audioKey: 'music4',  instruction: '【文法】スライド7に書かれている “She told me her name was Billie Jean” で、was が使われている文法ルール名はどれ？', choices: ['仮定法過去', '時制の一致', '原形不定詞', '受動態'], answer: '時制の一致', explanation: 'スライド7の文法解説に「時制の一致：told (過去) なので、name was (過去) となっています」と書かれています。' },
    { id: 18, stage: 2, type: 'choice', audioKey: 'music10', instruction: '【文法】スライド13に書かれている “is not” を短縮せずに強く発音しているマイケルの意図はどれ？', choices: ['英語の文法を間違えたから', '「絶対に違う！」という強い拒絶と潔白の主張', '怒って叫びたかったから', '歌のリズムが余ったから'], answer: '「絶対に違う！」という強い拒絶と潔白の主張', explanation: 'スライド13に「is not を短縮せずに強く発音することで、『絶対に違う！』というマイケルの強い拒絶と潔白の主張を表現しています」と書かれています。' },
    { id: 19, stage: 2, type: 'choice', audioKey: 'music11', instruction: '【文法】スライド14の語彙タグに書かれている接続詞 [ that ] の意味（塊の役割）は何ですか？', choices: ['「あれ」を指す', '「〜ということ」という内容の塊を作る', '「なぜなら」という理由を作る', '「もしも」という条件を作る'], answer: '「〜ということ」という内容の塊を作る', explanation: 'スライド14に「接続詞 that は『〜ということ』という内容の塊を作ります」と書かれています。' },
    { id: 20, stage: 2, type: 'choice', audioKey: 'music9',  instruction: '【文法】スライド12の語彙タグに書かれている “\'Cause” は、何の省略形ですか？', choices: ['Because', 'Case', 'Course', 'Cousin'], answer: 'Because', explanation: 'スライド12の語彙タグに「\'Cause [Because]」と記載されています。' },
    ...
    formDiv.innerHTML = `
        ...
        <div style="margin-bottom: 20px; text-align: left;">
            ...
            <select id="form-mode" style="width:100%; padding:8px; background:#443300; color:#ffff00; border:2px solid #ffff00; font-weight:bold;">
                ...
                <option value="STAGE1">【10問】ステージ1：単語・熟語部門</option>
                <option value="STAGE2">【10問】ステージ2：英文法部門</option>
...
function showExplanation(isCorrect) {
    ...
    let qText = this.add.text(0, -110, `問題: ${q.instruction.replace('【単語・熟語】','').replace('【文法】','')}`, { font: 'bold 15px monospace', fill: '#000000', wordWrap: { width: 760 }, align: 'center' }).setOrigin(0.5);
